...
app.post('/post', (req, res) => {
    ...
    if (/*TODO... check if the request action is generateCode*/){
			...
			var jsontext = JSON.stringify({
				/*TODO... type of action */
                /*TODO... won or not */
				/*TODO... number of match*/
                /*TODO... number of correct colors*/
                /*TODO... number of wrong colors*/
                /*TODO... the answer code when the game ends*/
                });
            console.log(jsontext);
            res.send(jsontext);
        } else {
...
}).listen(/*TODO... the port number this server listens to*/);
